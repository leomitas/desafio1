...
export default function Techs() {
  return (
    <section className='max-w-7xl mx-auto xl:px-0 pb-8 flex flex-col gap-16'>
      <div className='flex flex-col gap-8'>
        <h2 className='text-4xl text-center font-bold'>
          <span className='text-blue-700'>Conjunto de Habilidades</span>{' '}
          Profissionais
        </h2>
        <ul className='flex flex-wrap gap-6 justify-center'>
          <li className='flex justify-center md:px-20 p-8 border-2 border-blue-700 shadow-xl hover:scale-110 rounded-md'>
      ...
      <div className='flex flex-col gap-8'>
        <h2 className='text-4xl text-center font-bold'>
          <span className='text-blue-700'>Ferramentas</span> Que Utilizo
        </h2>
        <ul className='flex flex-wrap gap-6 justify-center'>
          <li className='flex justify-center md:px-20 p-8 border-2 border-blue-700 shadow-xl hover:scale-110 rounded-md'>
